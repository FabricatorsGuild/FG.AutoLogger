                ...
                try
                {
                    ...
                    if (!alreadyIncluded)
                    {
                        ...
                        if (include.ItemType == ProjectItemType.DefaultGeneratedEventSourceDefinition)
                        {
                            ...
                            project.AddFileToProject(filePath, "None", new Dictionary<string, string>
                            {
                        ...
                        {
                            project.AddFileToProject(filePath, "Content", new Dictionary<string, string>
                            {
                                { "AutoGen", "true"},
                                {"AutoGenerated", metadata},
                                { "DependentUpon",
                        ...
                        {
                            project.AddFileToProject(filePath, "Compile", new Dictionary<string, string>
                            {
                                {"AutoGen", "true"},
                                {"AutoGenerated", metadata},
                                { "DependentUpon",
