                ...
                try
                {
                    ...
                    if (!alreadyIncluded)
                    {
                        ...
                        if (include.ItemType == ProjectItemType.DefaultGeneratedEventSourceDefinition)
                        {
                            ...
                            addedItems = project.AddItem("None", includeName, new KeyValuePair<string, string>[]
                            {
                        ...
                        {
                            addedItems = project.AddItem("Content", includeName, new KeyValuePair<string, string>[]
                            {
                                new KeyValuePair<string, string>("AutoGen", "true"),
                                new KeyValuePair<string, string>("AutoGenerated", metadata),
                                new KeyValuePair<string, string>("DependentUpon",
