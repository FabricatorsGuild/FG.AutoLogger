...
namespace ConsoleApplication1
{
	internal sealed class ConsoleRunnerLogger : IConsoleRunnerLogger
	{
		...
		{
			ConsoleApplication1.Current.RunnerCreated(
				_autogenerated, 
				_machineName
			);
		...
		{
			ConsoleApplication1.Current.RunnerDestroyed(
				_autogenerated, 
				_machineName
			);
		...
		{
			ConsoleApplication1.Current.WaitingForKeyPress(
				_autogenerated, 
				_machineName
			);
		...
		{
			ConsoleApplication1.Current.KeyPressed(
				_autogenerated, 
				_machineName, 
				key
			);
		...
		public void UnsupportedKeyError(
			System.Exception ex)
		{
			ConsoleApplication1.Current.UnsupportedKeyError(
				_autogenerated, 
				_machineName, 
				ex
			);
		...
		{
			ConsoleApplication1.Current.StartLoop(
				_autogenerated, 
				_machineName
			);
		...
		{
			ConsoleApplication1.Current.StopLoop(
				_autogenerated, 
				_machineName
			);
		...
		public void RandomIntsGenerated(
			int[] values)
		{
			ConsoleApplication1.Current.RandomIntsGenerated(
				_autogenerated, 
				_machineName, 
				values
			);
