	...
	internal sealed class DependencyLogger : IDependencyLogger
	{
			...
			string content)
		{
		    return new ScopeWrapper(new IDisposable[]
		    {
		        ...
		        {
			ConsoleApplication1.Current.StartCallExternalComponent(
				_autogenerated, 
				_machineName, 
				requestName, 
				content
		            ...
		            {
			ConsoleApplication1.Current.StopCallExternalComponent(
				_autogenerated, 
				_machineName, 
				requestName, 
				content
			...
			string message)
		{
		    return new ScopeWrapper(new IDisposable[]
		    {
                ...
                ScopeWrapperWithAction.Wrap(() =>
		        {
			ConsoleApplication1.Current.StartRecieveMessage(
				_autogenerated, 
				_machineName, 
				message
			);
		            ...
		            return new ScopeWrapperWithAction(() =>
		            {
			ConsoleApplication1.Current.StopRecieveMessage(
				_autogenerated, 
				_machineName, 
				message
			);
