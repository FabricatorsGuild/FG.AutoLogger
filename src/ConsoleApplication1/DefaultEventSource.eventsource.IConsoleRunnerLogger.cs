...
namespace ConsoleApplication1
{
	internal sealed partial class DefaultEventSource.eventsource
	{
		...
		[Event(KeyPressedEventId, Level = EventLevel.LogAlways, Message = "Key Pressed {3}")]
		...
		[Event(UnsupportedKeyErrorEventId, Level = EventLevel.LogAlways, Message = "{3}", Keywords = Keywords.Error)]
		...
		[Event(RandomIntsGeneratedEventId, Level = EventLevel.LogAlways, Message = "Random Ints Generated {3}")]
