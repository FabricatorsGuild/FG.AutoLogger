/*******************************************************************************************
*  This class is autogenerated from the class C:\Code\labs\CodeEffect.Diagnostics.EventSourceGenerator\CodeEffect.Diagnostics.EventSourceGenerator\sample.cs
...
namespace CodeEffect.Diagnostics.EventSourceGenerator
{
	...
	internal sealed partial class sample : EventSource
	{
		...
		[Event(ActorErrorEventId, Level = EventLevel.Warning, Message = "{12}")]
		...
		[Event(SomeDomainEventWithActorEventId, Level = EventLevel.Informational, Message = "{10}")]
