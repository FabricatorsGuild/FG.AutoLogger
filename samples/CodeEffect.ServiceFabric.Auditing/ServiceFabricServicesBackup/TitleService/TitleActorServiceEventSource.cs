/*******************************************************************************************
*  This class is autogenerated from the class TitleActorServiceEventSource.eventsource.json
...
{
	[EventSource(Name = "CodeEffect-ServiceFabric-Auditing-TitleService")]
	internal sealed partial class TitleActorServiceEventSource : EventSource
	{
		public static readonly TitleActorServiceEventSource Current = new TitleActorServiceEventSource();

		static TitleActorServiceEventSource()
		{
		...
		private TitleActorServiceEventSource() : base() { }
		...
		{
			public const EventKeywords TitleService = (EventKeywords)0x1L;
	...
	internal static class TitleActorServiceEventSourceHelpers
	{
