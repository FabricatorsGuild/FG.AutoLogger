...
namespace PersonActor
{
	...
	internal class PersonActor : Actor, IPersonActor
	{
		...
		public async Task SetTitleAsync(string title, CancellationToken cancellationToken)
		{
            ...
            await this.StateManager.AddOrUpdateStateAsync(DomainStateName, new Person() { Name = this.GetActorId().GetStringId(), Title = title }, (key, value) => new Person(){Name = value.Name, Title = title}, CancellationToken.None);
