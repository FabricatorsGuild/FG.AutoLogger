...
namespace PersonActor
{
	internal sealed partial class PersonActorServiceEventSource
	{
		...
		[Event(StartRunAsyncLoopEventId, Level = EventLevel.LogAlways, Message = "Start Run Async Loop", Keywords = Keywords.PersonActorService, Opcode = EventOpcode.Start)]
		...
		[Event(StopRunAsyncLoopEventId, Level = EventLevel.LogAlways, Message = "Stop Run Async Loop", Keywords = Keywords.PersonActorService, Opcode = EventOpcode.Stop)]
		...
		[Event(RunAsyncLoopFailedEventId, Level = EventLevel.LogAlways, Message = "{11}", Keywords = Keywords.PersonActorService)]
